...
The data presented above are a summary of the raw growth data, which are available <a href="./docs/tables/growth_table.csv" download="logo.png">here</a>.
...
### Maize yield {-}
**Hopi maize grown during the PFP flourished in the Mesa Verde region.**

```{r yield-data, echo=FALSE, warning=FALSE, message=FALSE}
yields %>%
  dplyr::select(-`PFP experimental yield (kg/ha)`) %>%
  tabler("yield_table.html")
```

<iframe src="./tables/yield_table.html" width="100%" height="500px" frameborder="0" scrolling="no"></iframe>
