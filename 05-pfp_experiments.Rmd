...
### Ear diversity {-}
**The phenotypes presented by Hopi maize are strongly related to growing conditions.** The data presented below are a summary of the raw ear measurement data, which are available <a href="./docs/tables/ears_table.csv" download="PFP_ears_table.csv">here</a>.
