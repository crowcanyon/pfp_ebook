...
Corn seed saving techniques have been part of Pueblo culture for millennia. This lesson invites students to connect the practice of seed saving to plants' ability to adapt to drought and other extreme weather. Download the PDF versions of the [long](./lessons/PFP_Lesson-5_The-Short-Blue-Ear_Long.pdf) or [short](./lessons/PFP_Lesson-5_The-Short-Blue-Ear_Short.pdf) sessions.
...
*   Video: [*Popped Secret: The Mysterious Origin of Corn*](https://www.youtube.com/watch?v=mBuYUb_mFXA) (18 mins):
    <div class="embed-responsive embed-responsive-16by9">
    <iframe src="https://www.youtube.com/embed/mBuYUb_mFXA?modestbranding=1&rel=0&start=1" frameborder="0" gesture="media" showinfo="0" allow="encrypted-media" allowfullscreen></iframe>
    </div>
...
*   As the instructor, review and read the following resources to get an overview of the concepts that will be summarized and condensed in the lesson plan. 
    ...
    *   Video: _Popped Secret: The Mysterious Origin of Corn_ (18 mins): [https://www.youtube.com/watch?v=mBuYUb_mFXA](https://www.youtube.com/watch?v=mBuYUb_mFXA)
...
*   OPTIONAL: Film Guide: _Popped Secret: The Mysterious Origin of Corn_: [https://www.biointeractive.org/classroom-resources/activity-popped-secret-mysterious-origin-corn](https://www.biointeractive.org/classroom-resources/activity-popped-secret-mysterious-origin-corn). This guide to the "Popped Secret" film could be used as the basis for a follow-up lesson plan. It supplies discussion questions based on specific sections of the film and a student quiz.

#### Long Session {-}
***Long Session: Creating Colorful Corn and Seed Saving for Resilience***
...
> 
> --- <cite>Kuwanwisiwma 2005:16</cite>
...
**Cue up the "Popped Secret" video to view minutes 0:00 – 12:10.**
...
**How did the ancestral Pueblo farmers decide which corn plants to save seed from? **
...
-  **Tolerance of harsh conditions:** the ability to survive drought, wind, heat, altitude, floods and pests. Commercial seeds, developed in other parts of the country, often cannot adapt to the difficult local growing conditions on Hopi land.
-  **Kernel Color:** a solid layer of black color at the pointy end of the kernel can signify that a seed is healthy and will germinate well. 
...
-  **Number and arrangement of seeds on each cob: **long, tight lines of kernels, without gaps, are a better food source and are needed for ceremonial purposes.
-  **Time to maturity:** the plant must be able to finish its life cycle and produce a cob within the number of frost-free days on Hopi land.  
-  **Survival of long-term storage: **the kernels must be hard, without soft spots, in order to store well  throughout the winter, as a food source and as a reserve of seeds that will successfully germinate in the spring.
...
Use the [diagram of a corn kernel showing the endosperm](http://media.web.britannica.com/eb-media/54/166754-050-8DEB8E13.jpg) to support this discussion.

Use the whiteboard to write the following key terms and review them with the students:

**Photosynthesis:** a process used by plants, to make a sugary food that fuels its growth. Plants absorb the energy of the sun through their leaves, combine it with water and carbon dioxide, and make a sugar called glucose. 

    Fun Fact: The waste product of this process creates is oxygen! 

**Starch:** plants store the glucose they've made by converting it into starch. When you eat a starchy plant material, like a corn kernel, you receive its energy.
**Endosperm:** the plant stores its starch in this part of the seed.
**Carbohydrates:** a food-based energy source. Starchy plant material, like corn, is high in carbohydrates. People like to use "carbs" as a food source because the starch breaks down into glucose sugar and provide us with energy over a long period of time. Glucose that is unused by the body is stored in the body as fat. 
    **Fun Facts**: 
...
1.  Divide the class into working groups: "Corn Seed Saving Group" and "Corn Seed Dissection Group".
1.  After approximately 30 minutes, rotate the groups.
...
<span style="text-decoration:underline;">Corn Seed Dissection Group</span>
...
**Observe the diagram:** the embryo stores all the information about how the plant will look as it moves through its life cycle. This information is coded into the plant's genes, which the ancestral farmers learned to manipulate to meet their needs: 

    Diagram of a corn kernel showing the endosperm: [http://media.web.britannica.com/eb-media/54/166754-050-8DEB8E13.jpg](http://media.web.britannica.com/eb-media/54/166754-050-8DEB8E13.jpg)

**Observe a pre-dissected kernel:** the pre-dissected kernel that has been treated with iodine will highlight the "endosperm"; this is the part of the kernel where starch is stored.
...
**Distribute:** paper plates, pre-soaked corn kernels, a hand lens and a plastic knife to the student pairs. 
**Dissect**: Each student should have their own pre-soaked kernel to identify anatomy and examine the endosperm:
    ...
    1.  Add a solution of iodine and potassium iodide to test for the presence of starch:
        - To test for starch, place **a few drops** of the mixture on each corn kernel dissected by students. The solution will change color in the presence of starch. Alert the students that the solutions can stain skin and clothes.

##### Closing Circle {-}

**_Ancient farmers gave corn to the world. Now it is completely integrated into our modern life: it provides human food, animal food, and even fuel - corn is processed into an engine fuel called "ethanol." We have these innovative ancient farmers to thank for all the ways in which corn has improved our lives. The Hopi people have shown that, if we take seed saving and stewardship of the land seriously,  it is possible to protect sacred and productive varieties of corn for centuries._**
...
#### Short Session 1 {-}
***Short Session 1: Creating Colorful Corn***  
...
#### Short Session 2 {-}
***Short Session 2: Seed Saving for Resilience***
